    ...
    <div>
        <layout-main>
            ...
            <div class="row row-cols-4 g-3">
                <div v-for="user in datausers" :key="user" class="card col mr-1 col card m-2 shadow-sm p-3 bg-body rounded">
                    <img src="@/assets/img/default-pp.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
